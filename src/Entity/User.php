 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre utilisateur s'est déjà inscsrit avec cette adresse email, merci de la modifier"
 * )
 */
class User implements UserInterface
{
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Vos 2 mots de passe ne sont pas identiques !")
     */
    ...
    {
        //On récupère uniquement un tableau avec le nom des roles à partir de la liste des entités Role
        $rolesTitles = $this->userRoles->map(function($role) {
            return $role->getTitle();
        })->toArray();

        $rolesTitles[] = 'ROLE_USER';
